...
start the loop.
   ...
   !going to yield (<< 0+0) in Distributer
start to print something...
<< 0+0
going to next loop...
   -after yield (<< 0+0) in Distributer
      -after yield << 0  in Generator: i=0
      !going to yield << 1 in Generator: i=1
   !going to yield (<< 1+1) in Distributer
start to print something...
<< 1+1
going to next loop...
   -after yield (<< 1+1) in Distributer
      -after yield << 1  in Generator: i=1
      !going to yield << 2 in Generator: i=2
   !going to yield (<< 2+2) in Distributer
start to print something...
<< 2+2
going to next loop...
   -after yield (<< 2+2) in Distributer
      -after yield << 2  in Generator: i=2
      !going to yield << 3 in Generator: i=3
   !going to yield (<< 3+3) in Distributer
start to print something...
<< 3+3
going to next loop...
   -after yield (<< 3+3) in Distributer
